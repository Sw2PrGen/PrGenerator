 ...
 * The method "createHeading()" is called to start the creation process.
 */
public class HeadingCreator {
    
    /**
     * This method creates a heading and stores hands it to the database.
     * One template is randomly picked and filled with filling words. In the end
     * the complete heading can be passed to the database to store it.
     */
