...
public class OutputGenerator {
    ...
    private String headingText = PrGenerator.mainDatabase.getCreatedHeading();
    private String abstractText = PrGenerator.mainDatabase.getCreatedAbstract();
    private String bodyText = PrGenerator.mainDatabase.getCreatedText();
    private String picture = PrGenerator.mainDatabase.getChosenPicture();
            
    /*
     * this method creates out of the generated text an html version
     * the structure and the design of the html document complies with the DHBW design
     */
    public void generateOutput(){
        
        String finalHtmlDocument = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01//EN\"><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" /><head><title>" + headingText + "</title> <style type=\"text/css\">h1 {font-size: 14px; font-weight: normal;line-height: 1.4em;margin: 12px 0; text-transform: uppercase;}span.news-list-date {    float: right;    font-size: 11px;    padding-left: 5px} DIV.csc-textpic-text {     clear: both;} DIV.csc-textpic DIV.csc-textpic-single-image IMG { margin-bottom: 10px} DIV.csc-textpic IMG { border: medium none; } img { border: medium none;} html, body, table, th, td, div, li { font-family: arial,verdana,helvetica,lucida,sans-serif; font-size: 12px;  line-height: 1.4em;}html {    color: #2F3032;}</style></head><body><div style=\"margin-right:105px;\"><div class=\"csc-textpic-text\"> <span class=\"news-list-date\">07.03.2013</span><h1> " + headingText + "</h1><div class=\"news-single-item\"><div class=\"csc-textpic csc-textpic-intext-right-nowrap\"><div class=\"csc-textpic-imagewrap csc-textpic-single-image\"><div class=\"news-single-img\"><img width=\"240\" height=\"160\" border=\"0\" alt=\"\" src=\"" + picture + "\" align=\"right\"><p class=\"news-single-imgcaption\" style=\"width:240px;\"></p><p><strong>"+ abstractText + "</strong></p><p>" + bodyText + "</p></div></div></body>";
